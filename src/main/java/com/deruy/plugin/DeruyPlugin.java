...
public class DeruyPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getCommand("devent").setExecutor(new DeruyEventCommand(this));
        getCommand("koth").setExecutor(new KothCommand(this));
        getCommand("bingo").setExecutor(new BingoCommand(this));
        getCommand("bounty").setExecutor(new BountyCommand(this));
        getCommand("supplydrop").setExecutor(new SupplyDropCommand(this, false));
        getCommand("supersupplydrop").setExecutor(new SupplyDropCommand(this, true));
